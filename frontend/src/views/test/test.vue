...
import { getTest, type FullTestDto } from "@/api/tests";
import { computed, onMounted, ref } from "vue";
import { useRoute } from "vue-router";
import tCard from "@/components/layouts/t-card";
import tButton from "@/components/atoms/t-button/t-button.vue";
import { router } from "..";
...
const isSingle = computed(() => {
    ...
    return (
        currentQuestion.value.answers.filter((answer) => answer.is_correct)
            .length === 1
    );
});
            ...
            <div v-if="!isFinished">
                ...
                <!-- <div class="img-container mb-4">
                    <div class="img-content">
                        <img
                            src="https://i.gifer.com/embedded/download/NZFC.gif"
                            alt=""
                        />
                    </div>
                </div> -->
